...
public class InquiryVO {
	...
	//-----------------------------------------------------------------------------------------------------------
	public InquiryVO(int ef_i_no, String ef_i_title, String ef_content, String ef_imageFileName,
	...
	public String toString() {
		return "InquiryVO [ef_i_no=" + ef_i_no + ", ef_i_title=" + ef_i_title + ", ef_content=" + ef_content
