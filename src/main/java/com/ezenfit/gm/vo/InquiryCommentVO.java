...
public class InquiryCommentVO {
	...
	//-----------------------------------------------------------------------------------------------------------
	public InquiryCommentVO(int ef_i_no, int ef_comment, String ef_r_content, String ef_id, Date ef_r_date) {
		super();
	...
	public String toString() {
		return "InquiryCommentVO [ef_i_no=" + ef_i_no + ", ef_comment=" + ef_comment + ", ef_r_content=" + ef_r_content
				+ ", ef_id=" + ef_id + ", ef_r_date=" + ef_r_date + "]";
	}

	
} // End - public class InquiryCommentVO
